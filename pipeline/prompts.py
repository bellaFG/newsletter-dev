...
def build_triage_prompt(articles: list[dict]) -> str:
    payload = {
        ...
        "instructions": [
            ...
            "Retorne somente topicos que tenham pelo menos 3 source_ids com is_reference_source=true e source_identity distintos.",
            "Hacker News, Reddit, Lobste.rs, dev.to, GitHub Trending e outros agregadores/comunidades podem sinalizar pauta, mas nao contam como fonte de referencia.",
...
def build_editorial_plan_prompt(candidate_topics: list[dict], articles: list[dict]) -> str:
    payload = {
        ...
        "instructions": [
            ...
            "source_ids deve ter de 3 a 5 ids reais, todos com is_reference_source=true.",
            "As fontes de source_ids precisam ter source_identity distintos; nao use tres links do mesmo veiculo como se fossem tres fontes.",
            "primary_source_id deve estar dentro de source_ids e ser a fonte mais primaria/confiavel do conjunto.",
...
def build_writing_prompt(plan: dict, articles: list[dict]) -> str:
    payload = {
        ...
        "instructions": [
            ...
            "title_ptbr deve colocar resultado e consequencia na frente, com clareza em pt-BR na primeira leitura.",
            "Antes de devolver a resposta, revise title_ptbr, summary_ptbr e content_ptbr para garantir que um leitor brasileiro entenda sujeito, acao e impacto sem conhecer a fonte em ingles.",
            "Se uma metafora ou traducao literal ficar ambigua em portugues, reescreva de forma direta e concreta.",
            ...
            "Use as 3 ou mais fontes de referencia planejadas para checar fatos, contexto e consequencias antes de escrever.",
